...
/** Taille bornée : 2vw seul dépassait la demi-cellule (overflow → glyphes invisibles). */
function cellCharStyle(accentTextClass: string | undefined): React.CSSProperties {
  const color =
    accentTextClass === "text-neutral-900" ? "#171717" : "#fafafa";
  return {
    fontSize: "clamp(5px, min(1.35vw, 9px), 11px)",
    lineHeight: 1,
    color,
        ...
        {flipId > 0 && (
          ...
          >
            <div
              ...
              style={cellCharStyle(flapTextColor)}
            >
              {showPrev}
            </div>
            <motion.div
